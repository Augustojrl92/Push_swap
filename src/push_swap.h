...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/21 15:21:34 by aurodrig          #+#    #+#             */
/*   Updated: 2024/08/11 19:33:55 by aurodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_rotate_until_max_is_top(t_list **stack_a, char moves[], int i);
int		ft_count_numbers(char **av);
int		ft_find_best_cost(t_list **stack_a, t_list **stack_b, \
	char moves[], int i);
